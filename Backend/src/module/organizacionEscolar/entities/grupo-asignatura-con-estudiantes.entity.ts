...
@Entity({ name: "grupo_asignatura_con_estudiantes", schema: 'organizacion_escolar' })
export class GrupoAsignaturaConEstudiantes {
  ...
  @ManyToOne(() => GrupoAsignaturaDocente, grupo => grupo.gruposConEstudiantes, {
    onDelete: "CASCADE",
  })
  grupoAsignaturaDocente: GrupoAsignaturaDocente;

  @ManyToOne(() => StudentEntity, estudiante => estudiante.grupoAsignaturaConEstudiantes, {
    onDelete: "CASCADE",
  })
