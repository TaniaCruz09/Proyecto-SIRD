            ...
            <div className="grid gap-5 lg:grid-cols-[minmax(0,1.35fr)_minmax(280px,0.8fr)]">
              <section className="rounded-[28px] border border-stone-200 bg-white p-5 shadow-sm sm:p-6">
                <div className="mb-5 space-y-1">
                  ...
                  <p className="text-sm leading-6 text-slate-500">Primero selecciona el tipo de periodización, luego marca los cortes</p>
                </div>
              ...
              <section className="rounded-[28px] border border-stone-200 bg-[#fcfaf6] p-5 shadow-sm sm:p-6">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-slate-500">Este año guardará el tipo de periodización y los cortes; se generarán los períodos y hará la división automáticamente.</p>
                  </div>
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                  ...
                  <div className={`rounded-2xl border p-4 ${configuracionValida ? "border-emerald-200 bg-emerald-50" : "border-amber-200 bg-amber-50"}`}>
                    ...
                    <p className={`mt-2 text-sm font-semibold leading-6 ${configuracionValida ? "text-emerald-900" : "text-amber-900"}`}>
                      {configuracionValida
                        ? "La configuración está lista para guardar."
            ...
            <section className="rounded-[28px] border border-stone-200 bg-white p-5 shadow-sm sm:p-6">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <p className="text-sm leading-6 text-slate-500">Así se dividirán los cortes dentro de cada período generado automáticamente.</p>
                </div>
